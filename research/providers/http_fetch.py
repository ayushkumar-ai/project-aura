...
from research.extractor import extract_text_and_title_from_html
        ...
        try:
            with urllib.request.urlopen(req, timeout=effective_timeout) as response:
                ...
                if "html" in content_type or "<html" in decoded_text.lower():
                    clean_text, title = extract_text_and_title_from_html(decoded_text, max_chars=self.max_document_chars)
                else:
